<?php
    ...
    if(isset($_POST['submit'])) { //กดปุ่ม เปลี่ยนรหัสผ่าน
        ...
        $sql = "UPDATE restaurant SET password = '$newpassword' WHERE id = $id and password = '$oldpassword'"; // เตรียมคำสั่ง SQL
...
<head>
    ...
    <title>ผู้ดูแลร้านอาหาร - เปลี่ยนรหัสผ่าน</title> <!-- เปลี่ยน Title ของเว็บเพจ (ชื่อ Tab ของเว็บ) -->
